...
ActiveRecord::Schema.define(version: 20160413113627) do
  ...
  add_index "froms", ["specialist_id"], name: "index_froms_on_specialist_id"
  add_index "froms", ["visit_id"], name: "index_froms_on_visit_id"
